...
- **vifunguo vya umma** vitawakilishwa **mlalo**.
...
- **Muamala wa amana**: Alice anatayarisha muamala wa Bitcoin ili kuweka fedha kwenye Anwani hii ya sahihi nyingi. Kwa mfano, anaweza kuamua kutuma **Satoshi 130,000** kwa Anwani hii ya sahihi nyingi. Muamala huu umejengwa lakini bado haujachapishwa kwenye Blockchain.
...
Wakati wa kufungua chaneli, Alice aliweka **Satoshi 130,000** kwenye sahihi nyingi za Anwani za chaneli. Kwa hivyo, katika hali ya awali, pesa zote ziko upande wa Alice. Kabla ya kufungua kituo, Alice pia alimwagiza Bob atie sahihi **muamala wa kujiondoa**, ambao ungemruhusu kurejesha pesa zake ikiwa angetaka kufunga kituo.

![LNP201](assets/en/18.webp)

### Miamala ambayo haijachapishwa: Miamala ya kujitegemea.

Wakati Alice anafanya muamala katika kituo kutuma pesa kwa Bob, muamala mpya wa Bitcoin huundwa ili kuonyesha mabadiliko haya katika usambazaji wa fedha. Muamala huu, unaoitwa **kujitolea shughuli**, haujachapishwa kwenye Blockchain lakini unawakilisha hali mpya ya kituo kufuatia shughuli ya Umeme.
...
Ili kuthibitisha uhamisho huu, Alice na Bob wataunda **muamala mpya wa Bitcoin** ambao haujachapishwa ambao utatuma **satoshi 100,000 kwa Alice** na **satoshi 30,000 kwa Bob** kutoka kwa Anwani ya sahihi nyingi. Pande zote mbili huunda muamala huu kwa kujitegemea, lakini kwa data sawa (kiasi na anwani). Mara baada ya kujengwa, kila mmoja husaini shughuli na kubadilishana saini yake na nyingine. Hii inaruhusu upande wowote kuchapisha shughuli hiyo wakati wowote ikihitajika ili kurejesha sehemu yao ya kituo kwenye Bitcoin Blockchain kuu.

![LNP201](assets/en/19.webp)

### Mchakato wa Uhamisho: anwani ya ununuzi.

Bob anapotaka kupokea pesa, anamtumia Alice **_ ankara_**kwa Satoshi 30,000. Kisha Alice anaendelea kulipa ankara ya ununuzi hii kwa kuanzisha uhamisho ndani ya chaneli. Kama tulivyoona, mchakato huu unategemea kuundwa na kutiwa sahihi kwa **kujitolea shughuli** mpya.
...
### Jimbo jipya Baada ya Muamala wa Pili
...
Kama inavyoonekana hapo awali, miamala kwenye Umeme inategemea **shughuli ya kujitolea** ambayo haijachapishwa . Shughuli hizi zinaonyesha mgawanyo wa sasa wa fedha katika kituo. Wakati shughuli mpya ya Umeme inapofanywa, kujitolea shughuli mpya huundwa na kutiwa sahihi pande zote mbili ili kuonyesha hali mpya ya kituo.
...
- **Mzuri**: **kufungwa kwa ushirika**, ambapo Alice na Bob wanakubali kufunga kituo.
...
- **Mtoro**: **kufungwa kwa udanganyifu**, ambapo mmoja wa wahusika anajaribu kuiba fedha kwa kuchapisha kujitolea shughuli ya zamani (yoyote lakini si ya mwisho, ambayo inaonyesha mgawanyo halisi na wa haki wa fedha).

Hebu tuchukue mfano:


- Alice anamiliki **100,000 satoshi** na Bob **30,000 satoshi**.
- Usambazaji huu unaakisiwa katika **miamala 2** wa kujitolea (moja kwa kila mtumiaji) ambao haujachapishwa, lakini unaweza kuwa katika tukio la kufungwa kwa kituo.
...
Wakati nodi ya Alice inatuma ujumbe kwa Bob kuomba kufungwa kwa vyama vya ushirika, ikiwa hajibu (kwa mfano, kutokana na kukatika kwa mtandao au tatizo la kiufundi), Alice anaweza kuendelea na **kufungwa kwa kulazimishwa** kwa kuchapisha kujitolea shughuli iliyotiwa sahihi mwisho .
...
Muamala huu unajumuisha **muda wa fedha** za Alice, hivyo kufanya kufungwa polepole.
...
- **Satoshi 90,000** kwa upande wa **Suzie** na **satoshi 200,000** kwa upande wa **Carol** (mwenye waridi).
...
Kwa hiyo jukumu la nodi za kati ni muhimu sana katika utendaji wa Lightning Network. Huwezesha uhamishaji kwa kutoa njia nyingi za malipo. Ili kuhimiza nodi hizi kutoa ukwasi wao na kushiriki katika malipo ya uelekezaji, **ada za uelekezaji** hulipwa kwao.
...
- "**Ada ya msingi**": kiasi kisichobadilika kwa kila kituo, mara nyingi **1 Satoshi** ilikaa kama chaguo-msingi, lakini inayoweza kubinafsishwa.
...
**Kutuma ombi la malipo**: Bob anatuma anwani ya ununuzi kwa Alice akiomba malipo. **Awani hii ya ununuzi** inajumuisha haswa kuficha siri.
...
Katika sura hii, tutaangalia kwa karibu utendakazi wa Umeme **anwani ya ununuzi**, yaani, maombi ya malipo yaliyotumwa na nodi ya mpokeaji kwa nodi ya mtumaji. Lengo ni kuelewa jinsi ya kulipa na kupokea malipo kwenye Umeme. Pia tutajadili njia 2 mbadala za ankara za kawaida: LNURL na Keysend.
